...
export default function routes(app: express.Express): void {
  ...
  app.get('/case/select', AuthenticatedUser, async (req, res, next) => {
    caseSelectController(req, res, next)
  })

  // Page: Case dashboard
  app.get('/case/dashboard', AuthenticatedUser, async (req, res, next) => {
  ...
  app.get('/case/court-information', AuthenticatedUser, async (req, res, next) => {
  ...
  app.get('/case/court-information-2', AuthenticatedUser, async (req, res, next) => {
  ...
  app.get('/case/contact-details', AuthenticatedUser, async (req, res, next) => {
    courtInformationController(req, res, next, 'pages/case/contact-details')
  })

  app.get('/case/court-info-health', AuthenticatedUser, async (req, res, next) => {
